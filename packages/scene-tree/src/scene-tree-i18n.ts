...
export function getSceneTreeMessages(
  ...
  return {
    ...
    enterAction: formatMessage('sceneTree.enterAction', messages.enterAction),
    back: formatMessage('sceneTree.back', messages.back),
    enter: (label: string) => labelMessage('sceneTree.enter', messages.enter(label), label),
