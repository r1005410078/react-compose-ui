...
function ComposeStageReady({
  ...
  const draftingMessages = useMemo(() => ({
    ...
    mirrorTitle: messages.draftingMirrorTitle,
    mirrorFirstPoint: messages.draftingMirrorFirstPoint,
    mirrorSecondPoint: messages.draftingMirrorSecondPoint,
    mirrorDegenerateAxis: messages.draftingMirrorDegenerateAxis,
    alignLeftTitle: messages.draftingAlignLeftTitle,
    alignCenterXTitle: messages.draftingAlignCenterXTitle,
    alignRightTitle: messages.draftingAlignRightTitle,
    alignTopTitle: messages.draftingAlignTopTitle,
    alignCenterYTitle: messages.draftingAlignCenterYTitle,
    alignBottomTitle: messages.draftingAlignBottomTitle,
    distributeXTitle: messages.draftingDistributeXTitle,
    distributeYTitle: messages.draftingDistributeYTitle,
    alignmentNeedsMore: messages.draftingAlignmentNeedsMore,
    mirrorLabel: messages.draftingMirrorLabel,
    alignLabel: messages.draftingAlignLabel,
