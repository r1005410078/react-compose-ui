...
import { cloneStyle } from '../material-inspector-kit/default-values'
import type { ComposeBasicMaterialFrameOptions } from '../types'
...
export function createFramePreset(
  options: ComposeBasicMaterialFrameOptions = {},
