...
const messages = {
  'zh-CN': {
    ...
    workspaces: {
      ...
      paletteDescription: '排的是面板里有哪几段来源、怎么分组。文件夹来源按整段增删——新导入的符号自动出现在它所属的那一段里。',
      paletteSections: '面板货架',
      paletteAvailable: '未放入',
      paletteHeading: '面板标题',
      paletteSearch: '显示搜索框',
      paletteGroupBySubfolder: '按子文件夹分组',
      paletteCollapsed: '默认折叠',
      palettePresets: '列出的基础组件',
      paletteAddFolder: '添加来源…',
      paletteFolderPlaceholder: '文件夹路径，用 / 分隔；留空即全部项目组件',
  ...
  'en-US': {
    ...
    workspaces: {
      ...
      paletteDescription: 'You arrange which sources the panel lists and how they group. Folder sources are added and removed whole — newly imported symbols show up in their section on their own.',
      paletteSections: 'Palette',
      paletteAvailable: 'Not on the palette',
      ...
      paletteAddFolder: 'Add source…',
      paletteFolderPlaceholder: 'Folder path separated by /; empty means all project components',
