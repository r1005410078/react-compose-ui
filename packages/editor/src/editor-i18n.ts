...
const messages = {
  'zh-CN': {
    ...
    animationMode: {
      ...
      collapseAnimation: '收起动画',
      expandAnimation: '展开动画',
...
export function getEditorMessages(
  ...
  return {
    ...
    animationMode: {
      ...
      collapseAnimation: format('animationMode.collapseAnimation', current.animationMode.collapseAnimation),
      expandAnimation: format('animationMode.expandAnimation', current.animationMode.expandAnimation),
