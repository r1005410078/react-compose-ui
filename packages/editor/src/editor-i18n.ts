...
const messages = {
  'zh-CN': {
    ...
    crosshairFade: '渐隐（默认）',
    crosshairHalo: '晕圈',
    crosshairHint: '渐隐：贯穿图面的对齐参照，远端淡出。晕圈：细线下垫一圈画布底色，压在红导线与白符号上都读得出。臂长仍由工作区决定。',
    shortcuts: '快捷键',
    dark: '深色',
    light: '浅色',
    system: '跟随系统',
  ...
  'en-US': {
    ...
    crosshairHalo: 'Halo',
    crosshairHint: 'Fade: a full-reach alignment reference that fades toward the ends. Halo: a thin line over a canvas-colored underlay, readable on red wires and light symbols alike. Arm length is still set per workspace.',
